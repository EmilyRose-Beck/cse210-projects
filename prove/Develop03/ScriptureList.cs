...
using System.Collections.Generic;
    ...
    public class ScriptureList
        ...
        public ScriptureList()
        {
            ...
            _allScriptures.Add(new Reference("Moses", 1, 39, 0, "God's work and glory."));
            // Moses 7:18 — The people of Zion are of one heart and one mind.
            _allScriptures.Add(new Reference("Moses", 7, 18, 0, "The people of Zion are of one heart and one mind."));
            // Abraham 3:22–23 — The noble and great ones in the pre-earth life.
            _allScriptures.Add(new Reference("Abraham", 3, 22, 23, "The noble and great ones in the pre-earth life."));
            // Genesis 1:26–27 — God creates man in His image.
            _allScriptures.Add(new Reference("Genesis", 1, 26, 27, "God creates man in His image."));
